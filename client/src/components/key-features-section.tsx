          ...
          {features.map((feature, index) => {
            ...
            return (
              <div key={index} className="group text-center">
                <div className="sophisticated-card bg-white/10 backdrop-blur-sm border-white/20 p-8 h-full">
                  <div className="w-20 h-20 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-xl">
                    <IconComponent className="text-white h-10 w-10" />
                  </div>
                  <div className="mb-6">
                    <div className="text-3xl font-bold text-yellow-300 mb-1">{feature.stat}</div>
                    <div className="text-sm text-white/60 uppercase tracking-wide">{feature.statLabel}</div>
                  </div>
